<?php require __DIR__ . '/api/auth.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <header class="city-site-header">
    ...
    <div class="city-site-header__main">
      ...
      <nav class="city-nav" aria-label="Maintenance navigation">
        ...
        <a href="admin.php">Maintenance</a>
      </nav>
    </div>
    ...
    <section class="admin-layout">
      <aside class="admin-list-panel" aria-label="Projects">
        <div class="admin-list-panel__header">
          <label for="projectSearch">Projects</label>
        ...
        <ul class="admin-project-list" id="adminProjectList"></ul>
      </aside>
